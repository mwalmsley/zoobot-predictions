...
if __name__ == '__main__':
    ...
    catalog_dir = '/media/home/Galaxy-Zoo-Euclid/data/pipeline_runs/v4_post_euclid_challenge/catalogs'
    snippet_dir = '/media/user/team_workspaces/Galaxy-Zoo-Euclid/data/zoobot/v4_post_euclid_challenge/snippets'
